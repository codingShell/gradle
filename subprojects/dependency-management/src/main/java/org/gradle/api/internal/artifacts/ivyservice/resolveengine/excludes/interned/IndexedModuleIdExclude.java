...
public class IndexedModuleIdExclude extends DelegatingIndexedExclude implements ModuleIdExclude {
    private final ModuleIdExclude delegate;

    IndexedModuleIdExclude(int index, ExcludeSpec delegate) {
        super(index, delegate);
        this.delegate = (ModuleIdExclude) delegate;
    }
