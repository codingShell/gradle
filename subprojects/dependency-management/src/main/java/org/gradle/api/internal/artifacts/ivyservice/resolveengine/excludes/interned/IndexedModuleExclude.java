...
public class IndexedModuleExclude extends DelegatingIndexedExclude implements ModuleExclude {
    private final ModuleExclude delegate;

    IndexedModuleExclude(int index, ExcludeSpec delegate) {
        super(index, delegate);
        this.delegate = (ModuleExclude) delegate;
    }
