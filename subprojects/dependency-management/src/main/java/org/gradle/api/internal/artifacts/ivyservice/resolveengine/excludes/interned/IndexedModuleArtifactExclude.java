...
public class IndexedModuleArtifactExclude extends DelegatingIndexedExclude implements ArtifactExclude {
    private final ArtifactExclude delegate;

    IndexedModuleArtifactExclude(int index, ExcludeSpec delegate) {
        super(index, delegate);
        this.delegate = (ArtifactExclude) delegate;
    }
