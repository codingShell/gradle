...
final class IndexedGroupExclude extends DelegatingIndexedExclude implements GroupExclude {
    private final GroupExclude delegate;

    IndexedGroupExclude(int index, ExcludeSpec delegate) {
        super(index, delegate);
        this.delegate = (GroupExclude) delegate;
    }
